...
<table  border="1" align="center" width="570" cellspacing="0"  bgcolor="#71CABF" class="font1">
	...
	<th>ISBN</th><th>还书</th></tr>
	<s:iterator value="#request.queryList2" id="lend">
	<tr>
		...
		<td><a href="returnBook.action?lendBook.LendBook_Id=<s:property value="#request.returnId" />"><input type="button" value="确认还书"></a></td>
	</tr>
	</s:iterator>
</table>
